...
public class OptionsActivity extends AppCompatActivity {
    ...
    public void printDatabase(){
        ArrayList<Currency> currencies = dbHandler.getCurrencies();     //Creates an ArrayList filled with Currency named currencies from the database
    ...
    public void addButtonClicked(View view){    //Method for adding a Currency (Fiat/Crypto) with error-handling
    ...
    public void deleteButtonClicked(View view){     //Lazy deletefunction of a Currency
