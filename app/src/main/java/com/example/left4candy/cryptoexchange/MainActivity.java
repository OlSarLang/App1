...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void updateList(){
        ...
        ArrayList<String> curr = new ArrayList<String>();   //Creates an ArrayList for the names

        for (Currency c : currencies) {     //Fills the ArrayList with the names
            curr.add(c.getName());
        }
    ...
    @Override
    public void onNothingSelected(AdapterView<?> adapterView) { //Redundant
